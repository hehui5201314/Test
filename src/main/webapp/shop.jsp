...
<html>
<head>
<title>WelCome To HeHui WebMVC Shop | Home :: hehui</title>
<!--/tags -->
	...
	<div class="header-bot_inner_wthreeinfo_header_mid">
		...
		<!-- header-bot -->
			<div class="col-md-4 logo_agile">
				<h1><a href="index.html"><span>HeHui</span>Shop<i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
			</div>
        <!-- header-bot -->
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="active menu__item menu__item--current"><a class="menu__link" href="lol.jsp">LOLShop<span class="sr-only">(current)</span></a></li>
					<li class=" menu__item"><a class="menu__link" href="flower.jsp">Flower shop</a></li>
				<li class=" menu__item"><a class="menu__link" href="dangao.jsp">Cake shop</a></li>
					<li class="dropdown menu__item">
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">handbag  <span class="caret"></span></a>
					...
					<li class="menu__item dropdown">
					   <a class="menu__link" href="#" class="dropdown-toggle" data-toggle="dropdown">men’s  <b class="caret"></b></a>
								<ul class="dropdown-menu agile_short_dropdown">
									<li><a href="icons.html">Web Icons</a></li>
									<li><a href="typography.html">Typography</a></li>
								</ul>
					</li>
					<li class=" menu__item"><a class="menu__link" href="contact.html">About</a></li>
				  </ul>
				</div>
			  </div>
			</nav>	
					...
					<div class="modal-header">
						...
						<h3 class="agileinfo_sign">Sign Up <span>Now</span></h3>
						 <form action="#" method="post">
							...
							<div class="styled-input">
								<input type="password" name="Confirm Password" re quired=""> 
...
<!-- banner -->
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>League of legends mall <span>LOL</span></h3>
			...
			<div class="item item2"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>Summer <span>flower shop</span></h3>
			...
			<div class="item item3"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>The Delicious  <span>Cake</span></h3>
						<p>Special for today</p>
						<a class="hvr-outline-out button2" href="mens.html">Shop Now </a>
					</div>
				</div>
			...
			<div class="item item4"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>Summer <span>Noble bag</span></h3>
						<p>New Arrivals On Sale</p>
						<a class="hvr-outline-out button2" href="mens.html">Shop Now </a>
					</div>
				</div>
			...
			<div class="item item5"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>The men’s wear  <span>watches</span></h3>
						<p>Special for today</p>
						<a class="hvr-outline-out button2" href="mens.html">Shop Now </a>
					</div>
				</div>
	...
	<div class="schedule-bottom">
		<div class="col-md-6 agileinfo_schedule_bottom_left">
			<img src="images/Cg-4V1Q_K_2IS20UAAvKmTmHyYIAAQLGwOZI-YAC8qx308.jpg" alt=" " class="img-responsive" />
		</div>
...
<!-- //schedule-bottom -->
  ...
  <!-- 小模版3 -->
	...
	<div class="container">
		<h3 class="wthree_text_info">LoL <span> SkinShow</span></h3>
	
		<div class="col-md-5 bb-grids bb-left-agileits-w3layouts">
			<a href="womens.html">
			   <div class="bb-left-agileits-w3layouts-inner grid">
					<figure class="effect-roxy">
						<!-- 	<img src="images/9KS$0I7GD$$3O24EQ9ROJM4.png" alt=" " class="img-responsive" /> -->
								<img src="images/1ON%25L2M6OL$BE%7DJRXE%60%7D35J.png" alt=" " class="img-responsive" />
							<figcaption>
		...
		<div class="col-md-7 bb-grids bb-middle-agileits-w3layouts">
		      <a href="mens.html">
		       <div class="bb-middle-agileits-w3layouts grid">
			           <figure class="effect-roxy">
							<img src="images/w3.png" alt=" " class="img-responsive" />
							<figcaption>
								<h3><span>S</span>ale </h3>
								<p>Upto 55%</p>
							</figcaption>			
...
<!-- 小模版4 -->
      <div class="agile_last_double_sectionw3ls">
            <div class="col-md-6 multi-gd-img multi-gd-text ">
					<a href="#"><img src="images/9KS$0I7GD$$3O24EQ9ROJM4.png" alt=" "><h4>angel  <span>50%</span> offer</h4></a>
					
			</div>
			 <div class="col-md-6 multi-gd-img multi-gd-text ">
					<a href="#"><img src="images/HQCC%5DLU6I%7D%5DG39B%5DZ4ES8X4.png" alt=" "><h4>demon <span>50%</span> offer</h4></a>
			</div>
			<div class="clearfix"></div>
	   </div>							
<!--/grids-->
			...
			<div class="w3layouts_mail_grid">
				<div class="col-md-3 w3layouts_mail_grid_left">
					...
					<div class="w3layouts_mail_grid_left2">
						<h3>FREE SHIPPING</h3>
						<p>He Hui Provide special services</p>
					</div>
				</div>
				<div class="col-md-3 w3layouts_mail_grid_left">
					<div class="w3layouts_mail_grid_left1 hvr-radial-out">
...
<div class="footer">
	<div class="footer_agile_inner_info_w3l">
			...
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						...
						<li><a href="mens.html">Flower shop</a></li>
						<li><a href="womens.html">cake shop</a></li>
						<li><a href="about.html">hanbag</a></li>
						<li><a href="typography.html">Men's Wear and Watches</a></li>
						<li><a href="contact.html">Abut us</a></li>
					</ul>
				</div>
				...
				<div class="col-md-5 sign-gd-two">
					...
					<div class="w3-address">
						...
						<div class="w3-address-grid">
							...
							<div class="w3-address-right">
								<h6>Email Address</h6>
								<p>Email :<a href="#"> 827311078@qq.com.com</a></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="w3-address-grid">
		...
		<div class="clearfix"></div>
		 ...
		 <p class="copy-right">&copy 2019 HeHuiShop LOL.  | Design by <a href="#">HeHui</a></p>
	</div>
</div>
<!-- //footer -->
